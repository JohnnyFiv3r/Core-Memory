...
| `agent-led-semantic-write-integrity.md` | Agent-led semantic authorship, lossless multi-memory turn writes, delegated hosted authorship, truthful receipts, and causal judgment | **Partially implemented — Slice 1 shipped in #404; Slices 2–7 remain planned** |
