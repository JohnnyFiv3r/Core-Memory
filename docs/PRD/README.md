...
| `execution-plan-observation-ledger-stage-0.md` | Stage 0 contract, evaluation, corpus, baseline, and inventory execution plan | **Approved — PR-00A–PR-00B implemented; PR-00C–PR-00T sequentially gated** |
