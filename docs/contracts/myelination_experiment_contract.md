...
Strengthening/weakening is based on observed success/failure participation counts,
not elapsed time. No time-decay-based node punishment is introduced.

## Scoring Integration

When enabled:

- canonical search injects `myelination_bonus` into bead scoring context
