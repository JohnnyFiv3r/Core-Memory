...
- Status: in_progress
- PR/commit refs: feat/pr01-scaffolding-bootstrap (association append dedupe + turn-path hardening landed; flush once-per-cycle guard + explicit flush phase trace added; flush ownership closure still pending)
