...
- Status: in_progress
- PR/commit refs: feat/pr01-scaffolding-bootstrap (association append dedupe + turn-path hardening landed; flush once-per-cycle guard now added in memory_engine; flush ownership closure still pending)
