...
- Planned phase: deprecate in V2-P2, remove/further reduce in V2-P5
- Status: active
- Notes: may keep minimal compatibility wrapper during transition
...
- Status: active
- Notes: maintain only where operationally required
