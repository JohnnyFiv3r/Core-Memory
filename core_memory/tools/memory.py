...
def reason(query: str, root: str = "./memory", k: int = 8, debug: bool = False, explain: bool = False) -> dict:
    return memory_reason(query=query, root=root, k=int(k), debug=bool(debug), explain=bool(explain))
