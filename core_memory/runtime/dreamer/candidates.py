...
from core_memory.persistence.dreamer_candidate_store import (
    benchmark_tags_for_hypothesis as _benchmark_tags_for_hypothesis,
    candidate_key as _candidate_key,
    candidates_path as _candidates_path,
    enqueue_contradiction_pressure_candidates,
    make_candidate_row as _make_candidate_row,
    now_iso as _now,
    proposal_family as _proposal_family,
    read_candidates as _read_candidates,
    relationship_signal as _relationship_signal,
