...
from core_memory.graph.core import build_graph, graph_stats
...
from core_memory.graph.semantic import decay_semantic_edges
from core_memory.retrieval.semantic_index import build_semantic_index, semantic_lookup, semantic_doctor
...
def handle_graph_command(*, args: Any, memory: Any, graph_parser: Any) -> bool:
    ...
    if args.graph_cmd == "build":
        ...
        from core_memory.association.slo import association_slo_check
        ...
        from core_memory.integrations.neo4j import neo4j_status
        ...
        from core_memory.integrations.neo4j import sync_to_neo4j
