...
MCP_TYPED_WRITE_TOOL_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "maintain": {
        "description": (
            ...
            "decisions, seam-healing candidate submission, SOUL revisions, Myelination refresh, corrections, "
            "append-only semantic reauthoring, and pending-turn repair. Dry-run previews report required_authority, "
            "authority_ok, and validation_errors; live semantic maintenance requires a successful copied-tenant "
            "receipt."
        ),
        "input": {
            "type": "object",
