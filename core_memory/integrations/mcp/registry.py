    ...
    "status": MCPToolDefinition(
        ...
        output_schema={
            ...
            "properties": {
                ...
                "last_snapshot_source": {"type": ["string", "null"]},
                "last_snapshot_conversation_id": {"type": ["string", "null"]},
                "queue_depth": {"type": "integer"},
                "tools_version": {"type": "string"},
                "schema_version": {"type": "string"},
                "last_error": {"type": ["string", "null"]},
                "advertised_tools_count": {"type": "integer"},
