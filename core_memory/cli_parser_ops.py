...
def add_async_jobs_command_surfaces(
    *,
    ...
    ops_jobs_enqueue.add_argument("--kind", required=True, choices=["semantic-rebuild", "compaction"])
    ...
    async_jobs_enqueue_parser.add_argument("--kind", required=True, choices=["semantic-rebuild", "compaction"])
