...
def compute_failure_signature_for_store(plan: str) -> str:
    from core_memory.retrieval.failure_patterns import compute_failure_signature  # noqa: PLC0415
...
def find_failure_signature_matches_for_store(
    ...
    *,
    ...
    from core_memory.retrieval.failure_patterns import find_failure_signature_matches  # noqa: PLC0415
...
def preflight_failure_check_for_store(
    ...
    *,
    ...
    from core_memory.retrieval.failure_patterns import preflight_failure_check  # noqa: PLC0415
    index = store._read_json(store.beads_dir / "index.json")
