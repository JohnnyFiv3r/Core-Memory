...
TASK_GOAL_PROGRESS = "goal_progress"
TASK_CAUSAL_RECALL_EXECUTE = "causal_recall_execute"
...
DEFAULT_TASK_MODEL_TIERS = {
    ...
    TASK_GOAL_PROGRESS: MODEL_TIER_STANDARD,
    TASK_CAUSAL_RECALL_EXECUTE: MODEL_TIER_STANDARD,
    TASK_DREAMER_RESEARCH: MODEL_TIER_FRONTIER,
    TASK_SOUL_PROPOSAL: MODEL_TIER_FRONTIER,
