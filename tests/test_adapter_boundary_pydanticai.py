...
CORE_MODULES = (
    ...
    "core_memory.persistence.semantic_task_receipts",
    "core_memory.policy.semantic_task_runtime",
    "core_memory.policy.semantic_task_verifier",
    "core_memory.persistence.store",
    "core_memory.schema",
    "core_memory.schema.semantic_tasks",
    "core_memory.graph",
    "core_memory.claim",
    "core_memory.entity",
