...
class TestHttpContractAsyncOpsSlice52A(unittest.TestCase):
    def test_contract_declares_async_ops_endpoints(self):
        ...
        self.assertIn(("GET", "/v1/ops/dreamer/candidates"), eps)
        self.assertIn(("POST", "/v1/ops/dreamer/candidates/decide"), eps)
        self.assertIn(("GET", "/v1/memory/association-coverage/summary"), eps)
        self.assertIn(("GET", "/v1/memory/semantic-task-runs"), eps)
        self.assertIn(("GET", "/v1/memory/semantic-task-runs/summary"), eps)
        self.assertIn(("GET", "/v1/memory/association-candidates"), eps)
        self.assertIn(("POST", "/v1/memory/association-candidates/{candidate_id}/decide"), eps)
    ...
    def test_contract_endpoints_exist_in_http_server_routes(self):
        ...
        self.assertIn(("GET", "/v1/ops/dreamer/candidates"), route_pairs)
        self.assertIn(("POST", "/v1/ops/dreamer/candidates/decide"), route_pairs)
        self.assertIn(("GET", "/v1/memory/association-coverage/summary"), route_pairs)
        self.assertIn(("GET", "/v1/memory/semantic-task-runs"), route_pairs)
        self.assertIn(("GET", "/v1/memory/semantic-task-runs/summary"), route_pairs)
        self.assertIn(("GET", "/v1/memory/association-candidates"), route_pairs)
        self.assertIn(("POST", "/v1/memory/association-candidates/{candidate_id}/decide"), route_pairs)
